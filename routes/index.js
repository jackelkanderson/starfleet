...
function sendSQSMessage(result) {
  var params = {
      MessageBody: result,
      QueueUrl: 'https://sqs.us-west-2.amazonaws.com/386908507125/Showcase2.fifo', //TODO: dynamic URL
      DelaySeconds: 0,
      MessageAttributes: {
          'Result': {
              DataType: 'String',
...
function resetPipeline() {
  ...
  var fileToUpdate = "Showcase2/file.txt";  // Path to file in repo without leading slash
